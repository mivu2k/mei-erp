...
namespace MeiErp.Modules.Finance.Migrations
{
    ...
    [Migration("20260825123648_MergeAdvancesIntoPaymentRequests")]
    partial class MergeAdvancesIntoPaymentRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeiErp.Modules.Finance.EmployeeAdvance", b =>
                {
                    ...
                    b.ToTable("EmployeeAdvances", "finance");
                });

            modelBuilder.Entity("MeiErp.Modules.Finance.EmployeeAdvanceInstallment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("EmployeeAdvanceId", "Number")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");

                    b.ToTable("EmployeeAdvanceInstallments", "finance");
                });
            ...
            modelBuilder.Entity("MeiErp.Modules.Finance.EmployeeAdvanceInstallment", b =>
                {
                    b.HasOne("MeiErp.Modules.Finance.EmployeeAdvance", "EmployeeAdvance")
